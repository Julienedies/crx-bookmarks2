...
_libs_chrome_index__WEBPACK_IMPORTED_MODULE_0__["bookmarks"].on('onRemoved', function (id, changeInfo, event) {
...
var f = function f(tab) {
  if (!tab.url) return;
  _libs_chrome_index__WEBPACK_IMPORTED_MODULE_0__["bookmarks"].search(tab.url).then(function (list) {
...
_libs_chrome_index__WEBPACK_IMPORTED_MODULE_0__["tabs"].on(function () {//console.log(args)
}); // 记录浏览器访问记录, 统计最常使用的书签
...
_libs_chrome_index__WEBPACK_IMPORTED_MODULE_0__["tabs"].on('onUpdated', function (tabId, changeInfe, tab, event) {
...
/***/ 2:
/*!*********************************!*\
  !*** multi ./app/background.js ***!
  \*********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./app/background.js */"./app/background.js");
